...
| [idempotency-receipt-correlation](idempotency-receipt-correlation) | Correlate tool calls to counterparty receipts by idempotencyKey (fail-closed) | `agent-inspect` | No | No network | Stable | `pnpm --filter agent-inspect-recipe-idempotency-receipt-correlation start` |
